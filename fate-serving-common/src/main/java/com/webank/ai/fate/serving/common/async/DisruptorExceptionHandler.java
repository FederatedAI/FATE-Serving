...
public class DisruptorExceptionHandler implements ExceptionHandler {
    ...
    public void handleEventException(Throwable ex, long sequence, Object event) {
        logger.error("Disruptor event exception, {}", ex.getMessage(), ex);
    }

    @Override
    public void handleOnStartException(Throwable ex) {
        logger.error("Disruptor start exception, {}", ex.getMessage(), ex);
    }

    @Override
    public void handleOnShutdownException(Throwable ex) {
        logger.error("Disruptor shutdown exception, {}", ex.getMessage(), ex);
    }
}
