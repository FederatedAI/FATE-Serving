...
public class Bootstrap {
    ...
    public static void parseConfig() {
        ...
        try {
            ...
            MetaInfo.PROPERTY_INTERFACE_SINGLE_GUEST_PREREQUEST = environment.getProperty(Dict.PROPERTY_INTERFACE_SINGLE_GUEST_PREREQUEST);
            MetaInfo.PROPERTY_INTERFACE_SINGLE_GUEST_POSTREQUEST = environment.getProperty(Dict.PROPERTY_INTERFACE_SINGLE_GUEST_POSTREQUEST);
            MetaInfo.PROPERTY_INTERFACE_SINGLE_GUEST_PREDATA = environment.getProperty(Dict.PROPERTY_INTERFACE_SINGLE_GUEST_PREDATA);
            MetaInfo.PROPERTY_INTERFACE_SINGLE_GUEST_POSTDATA = environment.getProperty(Dict.PROPERTY_INTERFACE_SINGLE_GUEST_POSTDATA);
            MetaInfo.PROPERTY_INTERFACE_SINGLE_GUEST_PREMERGE = environment.getProperty(Dict.PROPERTY_INTERFACE_SINGLE_GUEST_PREMERGE);
            MetaInfo.PROPERTY_INTERFACE_BATCH_GUEST_PREREQUEST = environment.getProperty(Dict.PROPERTY_INTERFACE_BATCH_GUEST_PREREQUEST);
            MetaInfo.PROPERTY_INTERFACE_BATCH_GUEST_POSTREQUEST = environment.getProperty(Dict.PROPERTY_INTERFACE_BATCH_GUEST_POSTREQUEST);
            MetaInfo.PROPERTY_INTERFACE_BATCH_GUEST_PREDATA = environment.getProperty(Dict.PROPERTY_INTERFACE_BATCH_GUEST_PREDATA);
            MetaInfo.PROPERTY_INTERFACE_BATCH_GUEST_POSTDATA = environment.getProperty(Dict.PROPERTY_INTERFACE_BATCH_GUEST_POSTDATA);
            MetaInfo.PROPERTY_INTERFACE_BATCH_GUEST_PREMERGE = environment.getProperty(Dict.PROPERTY_INTERFACE_BATCH_GUEST_PREMERGE);
            MetaInfo.PROPERTY_INTERFACE_SINGLE_HOST_PREREQUEST = environment.getProperty(Dict.PROPERTY_INTERFACE_SINGLE_HOST_PREREQUEST);
            MetaInfo.PROPERTY_INTERFACE_SINGLE_HOST_POSTREQUEST = environment.getProperty(Dict.PROPERTY_INTERFACE_SINGLE_HOST_POSTREQUEST);
            MetaInfo.PROPERTY_INTERFACE_BATCH_HOST_PREREQUEST = environment.getProperty(Dict.PROPERTY_INTERFACE_BATCH_HOST_PREREQUEST);
            MetaInfo.PROPERTY_INTERFACE_BATCH_HOST_POSTREQUEST = environment.getProperty(Dict.PROPERTY_INTERFACE_BATCH_HOST_POSTREQUEST);
