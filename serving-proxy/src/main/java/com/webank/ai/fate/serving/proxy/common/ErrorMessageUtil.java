...
public class ErrorMessageUtil {
   ...
   public static  Map handleException(Map result,Throwable e){
       ...
       if (e instanceof IllegalArgumentException) {
           result.put(CODE, ErrorCode.PARAM_ERROR);
